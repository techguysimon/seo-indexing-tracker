...
from seo_indexing_tracker.services.sitemap_url_parser import parse_sitemap_urls_stream
    ...
    async def discover_urls(self, sitemap_id: UUID) -> URLDiscoveryResult:
        ...
        async with self._session_factory() as session:
            ...
            for discovered_url, (
                ...
                normalized_existing_lastmod = _normalize_datetime(existing_url.lastmod)
                normalized_discovered_lastmod = _normalize_datetime(discovered_lastmod)
...
__all__ = ["URLDiscoveryResult", "URLDiscoveryService"]
